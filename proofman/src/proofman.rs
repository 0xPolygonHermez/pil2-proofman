...
pub struct ProofMan<F: PrimeField64> {
    ...
    /// Lazily-populated cache of recurser-aggregator setups keyed by
    /// `recurser_id`. Registered via [`Self::register_recurser_setup`] and
    /// consumed by [`Self::prove_recurser_aggregator`].

    ...
    GoldilocksQuinticExtension: ExtensionField<F>,
{
    pub fn is_aggregation_rank(&self) -> bool {
        self.pctx.dctx_get_aggregation_rank() == self.pctx.dctx_get_rank() as i32
    }
    ...
    fn _verify_proof_constraints(
        ...
        if check_global_constraints && !test_mode {
            ...
            if self.pctx.dctx_is_aggregation_rank() {
    ...
    fn _generate_proof(
        ...
        if !options.aggregation {
            ...
            if options.verify_proofs {
                ...
                if !options.test_mode && self.pctx.dctx_is_aggregation_rank() {
                    let valid_global_constraints =
        ...
        if self.pctx.dctx_is_aggregation_rank() && options.verify_proofs {
    ...
    fn outer_aggregations(
        ...
        let vadcop_final_proof = Some(vadcop_proof_final.proof.clone());

...
#[cfg(not(feature = "no_lib_link"))]
pub fn get_contributions_size_c(p_stark_info: *mut c_void) -> u64 {
    unsafe { get_contributions_size(p_stark_info) }
}
...
#[cfg(feature = "no_lib_link")]
pub fn get_contributions_size_c(_p_stark_info: *mut c_void) -> u64 {
    trace!("··· {}", "get_contributions_size: This is a mock call because there is no linked library");
    100000000
}

...
pub fn set_mapOffsets_c(_pStarkInfo: *mut c_void, _pChelpers: *mut c_void) {
    trace!("{}: ··· {}", "ffi     ", "set_mapOffsets: This is a mock call because there is no linked library");
}
...
pub fn set_symbol_calculated_c(_pStarks: *mut c_void, _operand: u32, _id: u64) {
    trace!("{}: ··· {}", "ffi     ", "set_symbol_calculated: This is a mock call because there is no linked library");
}

...
extern "C" {
    ...
    pub fn unified_buffer_acquire(d_buffers: *mut ::std::os::raw::c_void);
    pub fn unified_buffer_release(d_buffers: *mut ::std::os::raw::c_void);
    pub fn unified_buffer_is_borrowed(d_buffers: *mut ::std::os::raw::c_void) -> u32;

...
impl DistributionCtx {
    ...
    #[inline]
    pub fn set_balande_distribution(&mut self, balance: bool) {
        self.balance_distribuiton = balance;
    }

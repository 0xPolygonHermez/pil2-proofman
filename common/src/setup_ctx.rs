...
pub struct SetupsVadcop<F: PrimeField64> {
    ...
    pub setup_vadcop_final_perf: Option<Setup<F>>,
...
impl<F: PrimeField64> SetupsVadcop<F> {
    pub fn new(
        ...
        if aggregation {
            ...
            let setup_vadcop_final_perf = Setup::new(
                &global_info.get_setup_path("vadcop_final"),
                0,
                0,
                &GlobalInfoAir::new("VadcopFinal".to_string()),
                &ProofType::VadcopFinalPerf,
                verify_constraints,
                preallocate,
                None,
            );
            ...
            let max_const_tree_size = sctx_compressor
                ...
                .max(setup_vadcop_final_perf.const_tree_size);
            ...
            let max_prover_buffer_size = sctx_compressor
                ...
                .max(setup_vadcop_final_perf.prover_buffer_size as usize);
            ...
            let max_prover_recursive_buffer_size = (sctx_recursive2.max_prover_buffer_size
                ...
                .max(setup_vadcop_final_perf.prover_buffer_size as usize + vadcop_final_trace_size as usize);
            ...
            let max_pinned_proof_size = sctx_compressor
                ...
                .max(setup_vadcop_final_perf.proof_size as usize);
            ...
            SetupsVadcop {
                ...
                setup_vadcop_final_perf: Some(setup_vadcop_final_perf),
                max_const_tree_size,
                max_const_size,
                max_prover_trace_size,
                max_prover_buffer_size,
    ...
    pub fn get_setup(&self, airgroup_id: usize, air_id: usize, setup_type: &ProofType) -> ProofmanResult<&Setup<F>> {
        match setup_type {
            ...
            ProofType::VadcopFinalPerf => Ok(self.setup_vadcop_final_perf.as_ref().unwrap()),

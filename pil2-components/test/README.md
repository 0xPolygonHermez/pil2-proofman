...
&& cargo build \
&& cargo run --bin proofman-cli setup --proving-key ./pil2-components/test/simple/build/provingKey -a \
...
&& cargo build \
&& cargo run --bin proofman-cli setup --proving-key ./pil2-components/test/std/connection/build/provingKey -a \
&& cargo run --bin proofman-cli verify-constraints \
...
&& cargo build \
&& cargo run --bin proofman-cli setup --proving-key ./pil2-components/test/std/diff_buses/build/provingKey -a \
&& cargo run --bin proofman-cli verify-constraints \
...
&& cargo build \
&& cargo run --bin proofman-cli setup --proving-key ./pil2-components/test/std/direct_update/build/provingKey -a \
&& cargo run --bin proofman-cli verify-constraints \
...
&& cargo build \
&& cargo run --bin proofman-cli setup --proving-key ./pil2-components/test/std/lookup/build/provingKey -a \
&& cargo run --bin proofman-cli verify-constraints \
...
&& cargo build \
&& cargo run --bin proofman-cli setup --proving-key ./pil2-components/test/std/permutation/build/provingKey -a \
&& cargo run --bin proofman-cli verify-constraints \
...
&& cargo build \
&& cargo run --bin proofman-cli setup --proving-key ./pil2-components/test/std/range_check/build/provingKey -a \
&& cargo run --bin proofman-cli prove \

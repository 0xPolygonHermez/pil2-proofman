...
pub const PILOUT_HASH: &str = "254f8096835551b0109f988255f6f5348f70135de7a7d0b642e013e06056432d";
...
trace_row!(SpecifiedRangesFixedRow<F> {
 OPID: [F; 4], VALS: [F; 4], __L1__: F,
});
pub type SpecifiedRangesFixed<F> = GenericTrace<SpecifiedRangesFixedRow<F>, 131072, 10, 0>;

trace_row!(SpecifiedRangesTraceRow<F> {
 mul:[F; 4],
});

pub type SpecifiedRangesTrace<F> = GenericTrace<SpecifiedRangesTraceRow<F>, 131072, 10, 0>;

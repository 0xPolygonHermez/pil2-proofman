    ...
    Standard: Distribution<F>,
{
    ...
    pub fn execute(&self, pctx: Arc<ProofCtx<F>>, ectx: Arc<ExecutionCtx>, sctx: Arc<SetupCtx>) {
        ...
        let num_rows = pctx.global_info.airs[MULTI_RANGE_CHECK_2_AIRGROUP_ID][MULTI_RANGE_CHECK_2_AIR_IDS[0]].num_rows;
        let air = pctx.pilout.get_air(MULTI_RANGE_CHECK_2_AIRGROUP_ID, MULTI_RANGE_CHECK_2_AIR_IDS[0]);
        ...
        let mut trace = MultiRangeCheck2Trace::new_zeroes(num_rows);

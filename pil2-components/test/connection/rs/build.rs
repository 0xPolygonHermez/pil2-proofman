...
const MANIFEST: &str = env!("CARGO_MANIFEST_DIR"); // .../pil2-components/test/connection/rs
const PIL: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../connection.pil");
...
fn main() {
    ...
    let pilout = format!("{out_dir}/connection.pilout");

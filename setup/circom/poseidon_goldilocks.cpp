...
// and adds the original input back to the permuted state before writing. This
// is the Merkle-node compression — 16 input field elements (e.g., four 4-element
// child hashes) reduced to a 16-element output of which the consumer typically

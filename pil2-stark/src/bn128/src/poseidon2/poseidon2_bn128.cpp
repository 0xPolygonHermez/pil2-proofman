...
void Poseidon2BN128::merkletree(FrElement* tree, Goldilocks::Element *trace, uint64_t rows, uint64_t cols, uint64_t linearHashArity, uint64_t arity)
{
	linearHash(tree, trace, rows, cols, linearHashArity);

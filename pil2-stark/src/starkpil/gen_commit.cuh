...
void genCommit_gpu(uint64_t arity, uint64_t nBits, uint64_t nBitsExtended, uint64_t nCols, gl64_gpu *d_aux_trace, Goldilocks::Element *root_pinned, SetupCtx *setupCtx, TimerGPU &timer, cudaStream_t stream) {

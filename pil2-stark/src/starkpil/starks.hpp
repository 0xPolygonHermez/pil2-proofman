...
public:
    ...
    void extendAndMerkelize_inplace(uint64_t step, gl64_t *d_witness, gl64_t *d_trace, DeviceCommitBuffers *d_buffers);
    ...
    void commitStage_inplace(uint64_t step, gl64_t *d_witness, gl64_t *d_trace, DeviceCommitBuffers *d_buffers);
    void computeQ(uint64_t step, Goldilocks::Element *buffer, FRIProof<ElementType> &proof, Goldilocks::Element* pBuffHelper = nullptr);
    void computeQ_inplace(uint64_t step, gl64_t *d_trace, DeviceCommitBuffers *d_buffers);

#ifndef EXPRESSIONS_GPU_REG_HPP
#define EXPRESSIONS_GPU_REG_HPP
...
__global__  void computeExpressions_reg__(StepsParams *h_params, DeviceArgumentsREG *d_deviceArgs, ExpsArguments *d_expsArgs, DestParamsGPU *d_destParams, bool debug, bool constraints);

class ExpressionsGPUREG : public ExpressionsCtx
{
public:
    uint32_t nRowsPack;
    uint32_t nBlocks;

...
extern "C" {
    ...
    void get_committed_pols(uint64_t *signalValues, uint64_t *witness2SignalList, uint64_t* execData, void *witness, void* pPublics, uint64_t sizeWitness, uint64_t N, uint64_t nPublics, uint64_t nCols);

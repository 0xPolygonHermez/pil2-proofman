...
extern "C" {
    ...
    int64_t prefetch_fixed(void *d_buffers_, uint64_t airgroupId, uint64_t airId, const char *constTreePath, uint64_t bytes);
    int64_t prefetch_recursive_tree(void *d_buffers_, void *pSetupCtx, uint64_t airgroupId, uint64_t airId, const char *proofType, const char *constTreePath);

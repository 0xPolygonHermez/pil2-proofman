...
namespace Plonk {
    ...
    public:
        ...
        std::tuple <json, json, std::vector<uint8_t>, std::vector<uint8_t>> prove(BinFileUtils::BinFile *fdZkey, BinFileUtils::BinFile *fdWtns);
        std::tuple <json, json, std::vector<uint8_t>, std::vector<uint8_t>> prove(BinFileUtils::BinFile *fdZkey, FrElement *wtns, WtnsUtils::Header* wtnsHeader = NULL);

        std::tuple <json, json, std::vector<uint8_t>, std::vector<uint8_t>> prove(BinFileUtils::BinFile *fdWtns);
        std::tuple <json, json, std::vector<uint8_t>, std::vector<uint8_t>> prove(FrElement *wtns, WtnsUtils::Header* wtnsHeader = NULL);

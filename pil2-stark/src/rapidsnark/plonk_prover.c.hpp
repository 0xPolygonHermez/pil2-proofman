...
namespace Plonk
{
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeT0()
    {
        #pragma omp parallel for
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeC1()
    {
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeT1()
    {
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeT2()
    {
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeC2()
    {
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeR0()
    {
        // COMPUTE R0
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeR1()
    {
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeR2()
    {
        // COMPUTE R2
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeF()
    {
        LOG_TRACE("··· Computing F polynomial");
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeZT()
    {
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeL()
    {
        LOG_TRACE("··· Computing L polynomial");
    ...
    template <typename Engine>
    void PlonkProver<Engine>::computeZTS2()
    {

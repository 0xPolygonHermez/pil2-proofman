...
public:
    ...
    inline void static merkletree(Goldilocks::Element *tree, Goldilocks::Element *input, uint64_t num_cols, uint64_t num_rows, int nThreads = 0, uint64_t dim = 1);
...
inline void PoseidonGoldilocks::hash_full_result(Goldilocks::Element *output, const Goldilocks::Element *input)
{
#ifdef __AVX512__
...
inline void PoseidonGoldilocks::hash(Goldilocks::Element (&state)[CAPACITY], const Goldilocks::Element (&input)[SPONGE_WIDTH]){
#ifdef __AVX512__

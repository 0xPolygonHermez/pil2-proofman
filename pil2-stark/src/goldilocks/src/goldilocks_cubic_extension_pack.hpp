...
inline void Goldilocks3::copy_pack( uint64_t nrowsPack, Goldilocks::Element *c_, const Goldilocks::Element *a_, bool const_a)
{
    if(const_a){
...
inline void Goldilocks3::add_pack( uint64_t nrowsPack, Goldilocks::Element *c_, const Goldilocks::Element *a_, bool const_a, const Goldilocks::Element *b_, bool const_b)
{
    if (const_a & const_b){
        for(uint64_t irow =0; irow<nrowsPack; ++irow){
            c_[irow] = a_[0] + b_[0];
...
inline void Goldilocks3::sub_pack( uint64_t nrowsPack, Goldilocks::Element *c_, const Goldilocks::Element *a_, bool const_a, const Goldilocks::Element *b_, bool const_b)
{
    if (const_a & const_b){
        for(uint64_t irow =0; irow<nrowsPack; ++irow){
            c_[irow] = a_[0] - b_[0];
...
inline void Goldilocks3::mul_pack(uint64_t nrowsPack, Goldilocks::Element *c_, const Goldilocks::Element *a_, bool const_a, const Goldilocks::Element *b_, bool const_b)
{
...
inline void Goldilocks3::mul_pack(uint64_t nrowsPack, Goldilocks::Element *c_, const Goldilocks::Element *a_, bool const_a, const Goldilocks::Element *challenge_, const Goldilocks::Element *challenge_ops_)
{   
    if( const_a ){
        for (uint64_t i = 0; i < nrowsPack; ++i)
        {
            Goldilocks::Element A = (a_[0] + a_[1]) * challenge_ops_[i];
            Goldilocks::Element B = (a_[0] + a_[2]) * challenge_ops_[nrowsPack + i];
            Goldilocks::Element C = (a_[1] + a_[2]) * challenge_ops_[2*nrowsPack + i];
            Goldilocks::Element D = a_[0] * challenge_[i];
            Goldilocks::Element E = a_[1] * challenge_[nrowsPack + i];
            Goldilocks::Element F = a_[2] * challenge_[2*nrowsPack + i];
            Goldilocks::Element G = D - E;
...
inline void Goldilocks3::op_pack( uint64_t nrowsPack, uint64_t op, Goldilocks::Element *c, const Goldilocks::Element *a, bool const_a, const Goldilocks::Element *b, bool const_b)
{
    switch (op)
    {
    case 0:
...
inline void Goldilocks3::op_31_pack( uint64_t nrowsPack, uint64_t op, Goldilocks::Element *c, const Goldilocks::Element *a, bool const_a, const Goldilocks::Element *b, bool const_b)
{
